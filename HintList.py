...
hintTable = {
    ...
    'Gerudo Valley Far Side -> Gerudo Valley Storms Grotto':    ("#behind a tent#, a rainy song reveals", None, 'entrance'),
    ...
    'Shadow Temple Warp Region -> Shadow Temple Entryway':      ("at the back of #the Graveyard#, there is", "the #Shadow Temple# entrance leads to", 'entrance'),
    'Lake Hylia -> Water Temple Lobby':                         ("deep #under a vast lake#, one can find", "the #Water Temple# entrance leads to", 'entrance'),
    'Sacred Forest Meadow -> Forest Temple Lobby':              ("deep #within the Meadow#, one can find", "the #Forest Temple# entrance leads to", 'entrance'),
    'Gerudo Fortress -> Gerudo Training Grounds Lobby':         ("#thieves# train within", "the #Gerudo Training Grounds# entrance leads to", 'entrance'),
    'Zoras Fountain -> Ice Cavern Beginning':                   ("in #a frozen fountain#, an opening leads to", "the #Ice Cavern# entrance leads to", 'entrance'),
    'Zoras Fountain -> Jabu Jabus Belly Beginning':             ("inside #a great deity#, one can find", "inside #Jabu Jabu#, one can find", 'entrance'),

    'Windmill':                                                 ("the #Windmill#", None, 'region'),
    'Links House Entrance':                                     ("Link's House", None, 'region'),
    'Temple of Time Entrance':                                  ("Temple of Time", None, 'region'),
